...
extension AppError: CustomDebugStringConvertible, Equatable {
...
public func ==(lfs: AppError, rfs: AppError) -> Bool {
	return lfs.debugDescription == rfs.debugDescription
}
...
extension AppError: CustomStringConvertible {
	...
	public var description: String {
		...
		case .permissionDenied(let p):				return p.description
		default: return ""
		}
	}
}
